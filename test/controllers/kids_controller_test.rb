...
class KidsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create kid" do
    assert_difference('Kid.count') do
      post kids_url, params: { kid: { amount: @kid.amount, name: @kid.name, team_id: @kid.team_id } }
    end
  ...
  test "should update kid" do
    patch kid_url(@kid), params: { kid: { amount: @kid.amount, name: @kid.name, team_id: @kid.team_id } }
